...
(cl:defmethod cl:initialize-instance :after ((m <nav_goal-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nav_goal-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xj_robot_pnc-srv:<nav_goal-request> is deprecated: use xj_robot_pnc-srv:nav_goal-request instead.")))

(cl:ensure-generic-function 'tar_x-val :lambda-list '(m))
(cl:defmethod tar_x-val ((m <nav_goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xj_robot_pnc-srv:tar_x-val is deprecated.  Use xj_robot_pnc-srv:tar_x instead.")
  (tar_x m))

(cl:ensure-generic-function 'tar_y-val :lambda-list '(m))
(cl:defmethod tar_y-val ((m <nav_goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xj_robot_pnc-srv:tar_y-val is deprecated.  Use xj_robot_pnc-srv:tar_y instead.")
  (tar_y m))

(cl:ensure-generic-function 'tar_z-val :lambda-list '(m))
(cl:defmethod tar_z-val ((m <nav_goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xj_robot_pnc-srv:tar_z-val is deprecated.  Use xj_robot_pnc-srv:tar_z instead.")
  (tar_z m))

(cl:ensure-generic-function 'tar_yaw-val :lambda-list '(m))
(cl:defmethod tar_yaw-val ((m <nav_goal-request>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xj_robot_pnc-srv:tar_yaw-val is deprecated.  Use xj_robot_pnc-srv:tar_yaw instead.")
  (tar_yaw m))
...
(cl:defmethod cl:initialize-instance :after ((m <nav_goal-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'nav_goal-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name xj_robot_pnc-srv:<nav_goal-response> is deprecated: use xj_robot_pnc-srv:nav_goal-response instead.")))

(cl:ensure-generic-function 'reach_ok-val :lambda-list '(m))
(cl:defmethod reach_ok-val ((m <nav_goal-response>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader xj_robot_pnc-srv:reach_ok-val is deprecated.  Use xj_robot_pnc-srv:reach_ok instead.")
  (reach_ok m))
