...
if(livox_repub_CONFIG_INCLUDED)
  return()
endif()
set(livox_repub_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(livox_repub_SOURCE_PREFIX /home/art/xj_robot_git/Medical_Robot/src/nav_node/xj_robot/src/thirdparty/livox_repub)
  set(livox_repub_DEVEL_PREFIX /home/art/xj_robot_git/Medical_Robot/devel)
  set(livox_repub_INSTALL_PREFIX "")
  set(livox_repub_PREFIX ${livox_repub_DEVEL_PREFIX})
else()
  set(livox_repub_SOURCE_PREFIX "")
  set(livox_repub_DEVEL_PREFIX "")
  set(livox_repub_INSTALL_PREFIX /home/art/xj_robot_git/Medical_Robot/install)
  set(livox_repub_PREFIX ${livox_repub_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'livox_repub' is deprecated")
...
set(livox_repub_FOUND_CATKIN_PROJECT TRUE)

if(NOT "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu " STREQUAL " ")
  set(livox_repub_INCLUDE_DIRS "")
  set(_include_dirs "/usr/include/pcl-1.10;/usr/include/eigen3;/usr/include;/usr/include/vtk-7.1;/usr/include/freetype2;/usr/include/x86_64-linux-gnu")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      get_filename_component(include "${livox_repub_DIR}/../../../include" ABSOLUTE)
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'livox_repub' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'livox_repub' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/art/xj_robot_git/Medical_Robot/src/nav_node/xj_robot/src/thirdparty/livox_repub/${idir}'.  ${_report}")
    endif()
    _list_append_unique(livox_repub_INCLUDE_DIRS ${include})
  endforeach()
endif()
...
foreach(library ${libraries})
  ...
  if("${library}" MATCHES "^(debug|optimized|general)$")
    list(APPEND livox_repub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-l")
    list(APPEND livox_repub_LIBRARIES ${library})
  elseif(${library} MATCHES "^-")
    # This is a linker flag/option (like -pthread)
    # There's no standard variable for these, so create an interface library to hold it
    if(NOT livox_repub_NUM_DUMMY_TARGETS)
      set(livox_repub_NUM_DUMMY_TARGETS 0)
    endif()
    # Make sure the target name is unique
    set(interface_target_name "catkin::livox_repub::wrapped-linker-option${livox_repub_NUM_DUMMY_TARGETS}")
    while(TARGET "${interface_target_name}")
      math(EXPR livox_repub_NUM_DUMMY_TARGETS "${livox_repub_NUM_DUMMY_TARGETS}+1")
      set(interface_target_name "catkin::livox_repub::wrapped-linker-option${livox_repub_NUM_DUMMY_TARGETS}")
    endwhile()
    ...
    list(APPEND livox_repub_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    endforeach()
    if(lib)
      _list_append_unique(livox_repub_LIBRARY_DIRS ${lib_path})
      list(APPEND livox_repub_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'livox_repub'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND livox_repub_LIBRARIES ${lib})
    endif()
  endif()
...
set(livox_repub_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${livox_repub_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 livox_repub_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${livox_repub_dep}_FOUND)
      find_package(${livox_repub_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${livox_repub_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(livox_repub_INCLUDE_DIRS ${${livox_repub_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(livox_repub_LIBRARIES ${livox_repub_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${livox_repub_dep}_LIBRARIES})
  _list_append_deduplicate(livox_repub_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(livox_repub_LIBRARIES ${livox_repub_LIBRARIES})

  _list_append_unique(livox_repub_LIBRARY_DIRS ${${livox_repub_dep}_LIBRARY_DIRS})
  _list_append_deduplicate(livox_repub_EXPORTED_TARGETS ${${livox_repub_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${livox_repub_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
